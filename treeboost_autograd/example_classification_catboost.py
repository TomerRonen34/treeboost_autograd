...
def main():
    ...
    custom_objective = CatboostObjective(loss_function=soft_margin_loss)
    model = CatBoostClassifier(loss_function=custom_objective, n_estimators=100, eval_metric="ZeroOneLoss")
